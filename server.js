...
const ENABLE_THINKING_MODE = true; // Enabled - fixed payload shape below
...
app.post('/v1/chat/completions', async (req, res) => {
  try {
    ...
    // FIX: NIM's REST API doesn't understand "extra_body" â€” that's an
    // openai-python SDK-only convenience wrapper. chat_template_kwargs
